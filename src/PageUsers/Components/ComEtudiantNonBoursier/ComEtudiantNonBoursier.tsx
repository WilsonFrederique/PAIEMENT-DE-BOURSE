      ...
      {isLoading ? (
        ...
        <div className="students-section">
          <div className="section-header">
            <h2><FaUniversity /> Étudiants Non Boursiers</h2>
            <div className="section-actions">
              <div className="search-filter-container">
                <div className="filter-options">
                  <select 
                    value={filterOption}
                    onChange={(e) => setFilterOption(e.target.value as 'all' | 'hasAccount' | 'noAccount')}
                  >
                    <option value="all">Tous les étudiants</option>
                    <option value="hasAccount">Avec compte</option>
                    <option value="noAccount">Sans compte</option>
                  </select>
                </div>
              </div>
          ...
          {filteredStudents.length > 0 ? (
            ...
            <div className="no-data">
              ...
              <p>Aucun étudiant non boursier trouvé</p>
              <button 
...
export default ComEtudiantNonBoursier;